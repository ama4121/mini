...
$(function () { /// jQB //////////////// 
	...
	sautocall = setInterval(factslide, 3000); // 3초 후 인터발 계속!

	///////////////////360/////////////////////////////

	for (var i = 1; i <= 50; i++) {
		$(".ex360box").append('<img class="exbox" src="images/5door/360view/5d' + i + '.jpg" alt="360view">');
	} /// for ////
...
/*MAKE YOURSELF 전역변수*/
var carset = [
		"c0.png", "c1.png", "c2.png", "c3.png", "c4.png", "c5.png"
	];
var cnum = 0;
